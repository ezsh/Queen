...
App.UnitSystems.Facet = class Facet {
	/**
	 *
...
App.UnitSystems.AbstractUnitSystem = class AbstractUnitSystem {
...
App.UnitSystems.Metric = class Metric extends App.UnitSystems.AbstractUnitSystem {
	constructor() {
		super();
...
App.UnitSystems.Imperial = class Imperial extends App.UnitSystems.AbstractUnitSystem {
	constructor() {
		super();
		this.length = new App.UnitSystems.Facet(
			1.0/2.54, [12, 5280],
...
App.UnitSystem = class UnitSystem {
	...
	static unitSettingChangedHandler() {
		...
		case "Imperial":
			window.App.unitSystem.system = new window.App.UnitSystems.Imperial();
			break;
		case "Metric":
			window.App.unitSystem.system = new window.App.UnitSystems.Metric();
			break;
		}
	}
};
